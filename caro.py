            ...
            if all(x == 2 for x in states):
                if combination[0] + self.grid_size == combination[1]: #horizontal
                    if combination[0] >= 0 and combination[0] <= self.grid_size - 1: # check left bound
                        ...
                        state_tail = self.boxes[combination[2] + self.grid_size].state
                        if state_head == 0 and state_tail == 0:
                            top1_attack.append(random.choice([combination[0] - self.grid_size, combination[2] + self.grid_size]))
                        elif state_head == 0:
                            top2_attack.append(combination[0] - self.grid_size)
                        elif state_tail == 0:
                            top2_attack.append(combination[2] + self.grid_size)
                    ...
                    if combination[0] % self.grid_size == 0: # check up bound
                        ...
                        state_tail = self.boxes[combination[2] + 1].state
                        if state_head == 0 and state_tail == 0:
                            top1_attack.append(random.choice([combination[0] - 1, combination[2] + 1]))
                        elif state_head == 0:
                            top2_attack.append(combination[0] - 1)
                        elif state_tail == 0:
                            top2_attack.append(combination[2] + 1)
                    ...
                    *
                    ...
                    if (combination[0] >= 0 and combination[0] <= self.grid_size - 1) or \
                        ...
                        state_tail = self.boxes[combination[2] + self.grid_size + 1].state
                        if state_head == 0 and state_tail == 0:
                            top1_attack.append(random.choice([combination[0] - self.grid_size - 1, combination[2] + self.grid_size + 1]))
                        elif state_head == 0:
                            top2_attack.append(combination[0] - self.grid_size - 1)
                        elif state_tail == 0:
                            top2_attack.append(combination[2] + self.grid_size + 1)
                ...
                #     """
                    if (combination[0] >= 0 and combination[0] <= self.grid_size - 1) or \
                        ...
                        if state_head == 0 and state_tail == 0:
                            ...
                            top1_attack.append(combination[0] - self.grid_size + 1)
                        elif state_tail == 0:
                            top1_attack.append(combination[2] + self.grid_size - 1)
